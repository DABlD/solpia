    ...
    <script>
        ...
        function addDocu(type){
        	...
        	var idOptions = [
        		...
        		'KOREAN VISA', 'CHINESE VISA', 'New Zealand eTA', 'HRIS ID', 'SCHENGEN VISA', 'NBI CLEARANCE', 'SRN'
        	];
			...
			lc_options += `
				...
				<optgroup label="TRAINING CERTIFICATES"></optgroup>
					...
					<option value="MARINE HIGH VOLTAGE">&nbsp;&nbsp;&nbsp;&nbsp;MARINE HIGH VOLTAGE - MAHIVO</option>
					<option value="MARINE HIGH VOLTAGE (Management Level)">&nbsp;&nbsp;&nbsp;&nbsp;MARINE HIGH VOLTAGE - MAHIVO (Management Level)</option>
				...
				<optgroup label="TANKER CERTIFICATES"></optgroup>
					...
					<option value="CARGO AND BALLAST HANDLING SIMULATOR - CBHS">&nbsp;&nbsp;&nbsp;&nbsp;CARGO AND BALLAST HANDLING SIMULATOR - CBHS</option>
