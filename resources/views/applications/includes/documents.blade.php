...
@push('before-scripts')
    <script>
        function addDocu(type){
        	...
        	var id_options = "";
        	var idOptions = [
        		'', 'PASSPORT', 'US-VISA', 'SEAMANS BOOK', 'MCV W/ PPRT'
        	];
