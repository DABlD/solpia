            ...
            let string = `
                <div class="row ss">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select name="type${count}" class="form-control aeigh">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control aeigh" name="from${count}" placeholder="Enter Start Year">
                        <span class="invalid-feedback hidden" role="alert">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control aeigh" name="to${count}" placeholder="Enter End Year">
                        <span class="invalid-feedback hidden" role="alert">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control aeigh" name="school${count}" placeholder="Enter School">
                        <span class="invalid-feedback hidden" role="alert">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control aeigh" name="address${count}" placeholder="Enter Address">
                        <span class="invalid-feedback hidden" role="alert">
