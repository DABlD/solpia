...
@push('after-scripts')
    <script>
        ...
        function batchExport(id, data){
            swal({
                ...
                inputOptions: {
                    ...
                    X45_BatchKoreanContractAgreement:   'Korean Flag Contract Agreement',
        ...
        function X43_BatchShinkoEntryDocs(id, name){
            let crews = [];
        ...
        function X45_BatchKoreanContractAgreement(id, name){
            let crews = [];
