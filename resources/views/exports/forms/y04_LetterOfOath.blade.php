<table>
	<tr>
		...
		<td colspan="15" style="height: 40px;">
			<img src="{{ public_path('images/letter_head.jpg') }}" width="500px" height="80px">
		</td>
		<td colspan="2" style="color: #FFF;">---------------------------------------------------------------</td>
	</tr>
	<tr><td colspan="19" style="text-align: center; height: 100px; vertical-align: middle; font-weight: bold; font-size: 20px;">LETTER OF OATH</td></tr>
	...
	<tr>
		<td colspan="2" style="color: #FFF; height: 40px;">---------------------------------------------------------------</td>
		<td style="text-align: right;" colspan="15">Nitta Kisen Kaisha Ltd.</td>
		<td colspan="2" style="color: #FFF;">---------------------------------------------------------------</td>
	</tr>
