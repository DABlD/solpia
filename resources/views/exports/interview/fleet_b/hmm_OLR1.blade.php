...
{{ $criteria('1. Carrying out cleanliness and good housekeeping in engine room using several materials, gears and cleaning solvents with consideration to safety.', 25) }}
{{ $criteria('2. Carrying out a watch routine appropiate to the duties of a rating forming part of engine room watch.', 25) }}
{{ $criteria('3.  Understanding of orders and  be understood in matters relevant to watchkeeping duties.', 25) }}
{{ $criteria('4. Monitoring various alarms in engine room and reporting to duty engineer') }}
{{ $criteria('5. The case should report to the duty engineer.') }}
{{ $criteria('6. The case should take over to duty releiver') }}
{{ $criteria('7. Knowledge for engine room pipeline system (bilge, G.S. , S.W. )') }}
{{ $criteria('8. Welding skills') }}
{{ $criteria('9. Lathing skills') }}
{{ $criteria('10. Check points and preparation for bunkering.') }}
{{ $criteria('11. Knowledge of kind and function of valves.') }}
{{ $criteria('12. Knowledge of the unit of pressure, temperature, weight, volume and length.') }}
{{ $criteria("13. Management of ship's stores and saving spare part.") }}
{{ $criteria('14. Emergency equipment operation and application of emergency procedure.') }}
{{ $criteria('15. Knowledge on oily water sapaerator and meaning of ppm.') }}
{{ $criteria('16. Knowledge of fire fighting equipment.') }}
{{ $criteria('17. Knowledge for prevention of fire.') }}
{{ $criteria('18. Knowledge for prevention of oil pollution.') }}
{{ $criteria('19. Disposal procedure of oily waste at sea and in port.') }}
{{ $criteria('20. Familiarization with ISM') }}
