...
<tr>
	...
	<td colspan="6" style="{{ $bold }} {{ $center }} font-size: 30px; height: 30px;">
		INTERVIEW SHEET FOR ABLE SEAMAN
	</td>
	<td colspan="2"></td>
</tr>
...
{{ $criteria('4. Operation of emergency equipment and apply emergency procedures', 25) }}
...
{{ $criteria('11. Check points when loading / discharging lashing equipments.') }}
{{ $criteria('12. Cargo damage prevention / damage reporting.') }}
{{ $criteria('13. Monitoring stevedores during loading / discharging operations.') }}
{{ $criteria('14. N/A') }}
{{ $criteria('15. N/A') }}
...
{{ $criteria('20. Preparation / securing container lashings.') }}
