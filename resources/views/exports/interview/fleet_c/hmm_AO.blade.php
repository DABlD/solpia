...
<tr>
	...
	<td colspan="6" style="{{ $bold }} {{ $center }} font-size: 30px; height: 30px;">
		INTERVIEW SHEET FOR APPRENTICE OFFICER
	</td>
	<td colspan="2"></td>
</tr>
...
{{ $criteria('1. Understanding of steering of the ship and complying with helm orders also in English Language', 25) }}
{{ $criteria('2. Knowledge in keeping a proper look-out by sight and hearing') }}
{{ $criteria('3. Contributing to monitoring,controlling and change over to a safe watch') }}
...
{{ $criteria('9. Operation of safety equipment (fire fighting, life saving appliances )') }}
...
{{ $criteria('14. Familiarization with ISM') }}
