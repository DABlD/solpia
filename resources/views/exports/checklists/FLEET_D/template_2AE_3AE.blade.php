...
{{ $doc("BT-PSSR", "BT-PSSR", 'lc') }}
	...
	@if(in_array($data->vessel->principal_id, [1]))
		{{ $doc("SAFETY OFFICER'S TRAINING COURSE", 'SHIP SAFETY OFFICERS COURSE', 'lc') }}
	...
	@elseif(in_array($data->vessel->principal_id, [14]))
		{{ $con("MTT - SMM 07 - 14 PRE-JOINING FAMILARISATION", 1,1,1) }}
		{{ $con("MTT - SMM 07 - 15 Pre BriefingJoining", 1,1,1) }}
		{{ $con("MTT - SMM 07 - 16 Briefing pre Joining", 1,1,1) }}
		{{ $con("MTT - SMM 07 - 18 DRUG & ALCOHOL DECLARATION", 1,1,1) }}
		{{ $doc("TEST", "", 'lc') }}
		{{ $doc("TEST", "", 'lc') }}
		{{ $doc("TEST", "", 'lc') }}
		{{ $doc("TEST", "", 'lc') }}
