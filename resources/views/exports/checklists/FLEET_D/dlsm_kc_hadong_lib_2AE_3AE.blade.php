...
<table>
	...
	{{ $doc("LIBERIA APPLICATION", "LIBERIA APPLICATION", 'flag') }}
	{{ $doc("COC", "LIBERIA LICENSE/CRA-APPLICATION", 'flag') }}
	{{ $doc("BT", "BT-SQC-APPLICATION", 'flag') }}
	{{ $doc("SDSD", "SDSD-SQC-APPLICATION", 'flag') }}

	{{ $section("3. NATIONAL LICENSES", 0) }}
	{{ $doc("COC", "C/E LICENSE (CERTIFICATE) - III/2", 'lc', 1, 'III/2') }}
	{{ $doc("COE", "C/E LICENSE (ENDORSEMENT) - III/2", 'lc', 1, 'III/2') }}
