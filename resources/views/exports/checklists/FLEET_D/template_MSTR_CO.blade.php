...
{{ $doc("BT-PSSR", "BT-PSSR", 'lc') }}
	...
	{{ $doc("MLC TRAINING F1", "MANAGEMENT LEVEL COURSE - DECK (F1)", 'lc', 2) }}
	{{ $doc("MLC TRAINING F2", "MANAGEMENT LEVEL COURSE - DECK (F2)", 'lc', 2) }}
	{{ $doc("MLC TRAINING F3", "MANAGEMENT LEVEL COURSE - DECK (F3)", 'lc', 2) }}
