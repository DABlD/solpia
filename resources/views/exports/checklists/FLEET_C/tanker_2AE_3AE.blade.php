...
<table>
	...
	{{ $doc("COE", "OIC-NW LICENSE (ENDORSEMENT) - III/1", 'lc', 0, 'III/1') }}
	...
	{{ $doc("SHIP SECURITY AWARENESS TRAINING & SEAFARERS WITH DESIGNATED SECURITY DUTIES - SDSD", "SDSD W/ TRAINING CERTIFICATE", 'lc') }}
