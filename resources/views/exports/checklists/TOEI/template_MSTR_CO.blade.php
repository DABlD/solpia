...
<table>
	...
	{{ $doc("MLC TRAINING F1", "MANAGEMENT LEVEL COURSE - DECK (F1)", 'lc') }}
	{{ $doc("MLC TRAINING F2", "MANAGEMENT LEVEL COURSE - DECK (F2)", 'lc') }}
	{{ $doc("MLC TRAINING F3", "MANAGEMENT LEVEL COURSE - DECK (F3)", 'lc') }}
