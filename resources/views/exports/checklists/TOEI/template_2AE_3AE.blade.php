...
{{ $doc("BT-PSSR", "BT-PSSR", 'lc') }}
	...
	{{-- // DIAMOND Q, WEST T, ULTRA C, QUEEN F, MARGUERITE, HAPPINESS B, PACIFIC I, AFRICAN L, CAPE S, HAPPINESS F, GOLD O, SILVER O, CORONA R, LADY M, ULTRA V, ALAM K, CENTURION S, NORVIC C, IKAN B, WISTERIA, INDIGO J, EGRET R, NORD A, NORD D, NORD ATOLL, OCEAN E, 'ULTRA R' --}}
	@elseif(in_array($data->vessel->id, [4613, 4615, 938, 4620, 4802, 5587, 61, 5, 6200, 27, 940, 949, 743, 952, 67, 6196, 5563, 6141, 4626, 4648, 4610, 4579, 4647, 4649, 6360, 9536, 9612]))
		{{-- CE/1AE --}}
