...
<table>
	...
	{{ $doc("OLC TRAINING F1", "OPERATIONAL LEVEL COURSE - ENGINE (F1)", 'lc', 2) }}
	{{ $doc("OLC TRAINING F2", "OPERATIONAL LEVEL COURSE - ENGINE (F2)", 'lc', 2) }}
	{{ $doc("OLC TRAINING F3", "OPERATIONAL LEVEL COURSE - ENGINE (F3)", 'lc', 2) }}
	{{ $doc("OLC TRAINING F4", "OPERATIONAL LEVEL COURSE - ENGINE (F4)", 'lc', 2) }}
	...
	{{-- // DIAMOND Q, WEST T, ULTRA C, QUEEN F, MARGUERITE, HAPPINESS B, PACIFIC I, AFRICAN L, CAPE S, HAPPINESS F, GOLD O, SILVER O, CORONA R, LADY M, ULTRA V, ALAM K, CENTURION S, NORVIC C, CMB M, IKAN B, CAMELLIA I, DORIC K, WISTERIA, INDIGO J, EGRET R, NORD A, NORD D, NORD ATOLL, OCEAN E--}}
	@elseif(in_array($data->vessel->id, [4613, 4615, 938, 4620, 4802, 5587, 61, 5, 6200, 27, 940, 949, 743, 952, 67, 6196, 5563, 6141, 4659, 4626, 4625, 4646, 4648, 4610, 4579, 4647, 4649, 6360, 8858, 9540, 9536]))
		{{-- CE/1AE --}}
