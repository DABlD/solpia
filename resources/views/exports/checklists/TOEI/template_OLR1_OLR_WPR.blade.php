...
<table>
	...
	{{ $doc("COC", "MARINA COP III/4 - ENGINEERING WATCH", 'lc', 1, 'III/4') }}
	{{ $doc("COE", "MARINA COP III/5 - ABLE SEAFARER ENGINE", 'lc', 1, 'III/5') }}
	...
	{{ $doc("ENGINE WATCH", "ENGINE WATCHKEEPING", 'lc') }}
	{{ $doc("CONSOLIDATED MARPOL", "CONSOLIDATED MARPOL (ANNEX I-VI)", 'lc') }}
	{{ $doc("WELDING", "WELDING TRAINING", 'lc') }}
	{{ $doc("EMPTY", "", 'lc') }}
	{{ $doc("EMPTY", "", 'lc') }}
	{{ $doc("EMPTY", "", 'lc') }}
	{{ $doc("EMPTY", "", 'lc') }}
