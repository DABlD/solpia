...
{{ $doc("BT-PSSR", "BT-PSSR", 'lc') }}
	...
	{{ $doc("ECDIS SPECIFIC", "ECDIS - SPECIFIC", 'lc', 1) }}
	{{ $doc("SSBT WITH BRM", "SSBT WITH BRM", 'lc', 1) }}
	{{ $doc("MLC TRAINING F1", "MANAGEMENT LEVEL COURSE - DECK (F1)", 'lc', 1) }}
	{{ $doc("MLC TRAINING F2", "MANAGEMENT LEVEL COURSE - DECK (F2)", 'lc', 1) }}
	{{ $doc("MLC TRAINING F3", "MANAGEMENT LEVEL COURSE - DECK (F3)", 'lc', 1) }}
	{{ $doc("CONSOLIDATED MARPOL", "CONSOLIDATED MARPOL (ANNEX I-VI)", 'lc', 1) }}
	{{ $doc("ARPA TRAINING COURSE", "ARPA / ROPA / RNPUA", 'lc', 1) }}
	{{ $doc("RADAR", "RADAR SIMULATOR COURSE", 'lc', 1) }}
