...
<table>
	...
	{{ $doc("LICENSE", "LIBERIA COC - OFFICER IN CHARGE", 'flag') }}
	{{ $doc("GMDSS/GOC", "LIBERIA GOC", 'flag') }}
	{{ $doc("BT", "LIBERIA SQC - BT", 'flag') }}
	{{ $doc("PSCRB", "LIBERIA SQC - PSCRB", 'flag') }}
	{{ $doc("AFF", "LIBERIA SQC - AFF", 'flag') }}
	{{ $doc("MEFA", "LIBERIA SQC - MEFA", 'flag') }}
	{{ $doc("MECA", "LIBERIA SQC - MECA", 'flag') }}
