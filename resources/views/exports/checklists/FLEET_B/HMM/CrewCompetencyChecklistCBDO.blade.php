...
<table>
	...
	<tr>
		...
		<td rowspan="3">
			...
			section 8.11 (IMSBC)<br>
			section 9.2 (Hatch cover)<br>
			section 4.2 (Safety officer)
		</td>
	</tr>

	<tr>
		<td colspan="2">IMSCBC{{ "<International Maritime" }}<br>{{ "Solid Bulk Cargoes Code>(Bulk only)" }}</td>
		<td>MTR &#38; D.Officer</td>
		<td></td>
		<td></td>
		<td></td>
	...
	<tr>
		<td colspan="2">Hatch cover(Bulk only)</td>
		<td>-</td>
		<td>MTR, C/O</td>
		<td></td>
		<td></td>
	...
	<tr>
		...
		<td></td>
		<td></td>
		<td>Ballast Water Management Law</td>
	</tr>

	<tr>
		<td colspan="2">Ship Handling Simulation</td>
		<td>-</td>
		<td>Y ▢</td>
		<td>N ▢</td>
		<td>Y ▢ N ▢</td>
	...
	<tr>
		<td colspan="2">Marine Pollution Prevention</td>
		<td>5Y</td>
		<td>C/O</td>
		<td></td>
		<td></td>
	...
	<tr>
		<td colspan="2">Anti Piracy Training</td>
		<td>5Y</td>
		<td>
			MTR, CO<br>
			(Korean flag/BBCHP)
		...
		<td></td>
		<td></td>
		<td>Pirate Damage Prevention Act</td>
	</tr>
