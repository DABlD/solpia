...
<table>
	...
	{{ $doc("MLC TRAINING F1", "OLC TRAINING FOR OIC-EW - F1/ M1 & ,M2", 'lc') }}
	{{ $doc("MLC TRAINING F2", "MLC TRAINING DECK - F2/ M1", 'lc') }}
	{{ $doc("MLC TRAINING F4", "OLC TRAINING FOR OIC-EW - F4/ M1 & ,M2", 'lc') }}
