...
<table>
	...
	{{ $doc("LICENSE", "MALTA LICENSE COC ID", 'flag') }}
	...
	{{ $doc("ECDIS FURUNO 3100/3200/3300", "ECDIS SPECIFIC: FURUNO ECDIS FMD-3100", 'lc') }}
	...
	{{ $doc("HDOS FAMILIARIZATION", "HDOS FAMILIARIZATION", 'lc') }}
