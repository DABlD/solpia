...
<table>
	...
	{{ $doc("LICENSE", "MARSHALL COC - OFFICER IN CHARGE", 'flag') }}
	{{ $doc("GMDSS/GOC", "MARSHALL GOC", 'flag') }}
	{{ $doc("BT", "MARSHALL SQC - BT", 'flag') }}
	{{ $doc("PSCRB", "MARSHALL SQC - PSCRB", 'flag') }}
	{{ $doc("AFF", "MARSHALL SQC - AFF", 'flag') }}
	{{ $doc("MEFA", "MARSHALL SQC - MEFA", 'flag') }}
	{{ $doc("MECA", "MARSHALL SQC - MECA", 'flag') }}
	{{ $doc("SDSD", "MARSHALL SQC - SDSD", 'flag') }}

	{{ $section("3. NATIONAL LICENSES", 0) }}
	{{ $doc("COC", "OIC-NW LICENSE (CERTIFICATE) - II/2", 'lc', 1, 'II/2') }}
	{{ $doc("COE", "OIC-NW LICENSE (ENDORSEMENT) - II/2", 'lc', 1, 'II/2') }}
	...
	{{ $doc("ECDIS SPECIFIC", "ECDIS - SPECIFIC: ________", 'lc') }}
	...
	{{ $doc("BASIC MARITIME COMPUTER COURSE", "BASIC MARITIME COMPUTER COURSE", 'lc') }}

	{{ $section("6. MEDICAL / VACCINATION", 0) }}
	{{ $doc("MEDICAL CERTIFICATE", "MEDICAL CERTIFICATE", 'med_cert') }}
	{{ $doc("FLAG MEDICAL", "MARSHALL MEDICAL CERTIFICATE", 'med_cert') }}
	...
	{{ $doc("COVID-19 1ST DOSE", "COVID 19 VACCINE", 'med_cert') }}
