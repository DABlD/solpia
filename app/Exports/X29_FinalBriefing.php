...
class X29_FinalBriefing implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->getHeaderFooter()->setOddFooter("&LDoc. NO. SMOP-FB-06 &CEffective Date: 01 SEPT 17 &R&K55B6DDREVISION NO: 2.0 / 22 May '23");
                ...
                $event->sheet->getDelegate()->getColumnDimension('H')->setWidth(37);
                ...
                $event->sheet->getDelegate()->getStyle('A3:L150')->getFont()->setSize(9);
