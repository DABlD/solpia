...
class KmtcChem implements WithMultipleSheets
{
    use Exportable;
    ...
    public function sheets(): array
    {
        ...
        // }
        array_push($sheets, new KmtcChemR($this->applicant, $this->type . 'r'));
        array_push($sheets, new Kmtc2($this->applicant, 'kmtc2'));
