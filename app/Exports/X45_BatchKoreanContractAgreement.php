...
class X45_BatchKoreanContractAgreement implements WithMultipleSheets
{
    use Exportable;
    ...
    {
        $sheets = [];
        $class = "App\Exports\\X44_BatchKoreanContractAgreement";

        foreach($this->applicants as $applicant){
            array_push($sheets, new $class($applicant,'X44_BatchKoreanContractAgreement',$applicant->rank));
        }
