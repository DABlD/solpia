...
class KlcsmBulkOnOff implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->setTitle('교대통보', false);
                ...
                // SIZES
                // SIZES
                $lus = sizeof($this->linedUps) * 2;
                $obs = sizeof($this->onBoards) * 2;
                ...
                $event->sheet->getDelegate()->getColumnDimension('B')->setWidth(35.7);
                $event->sheet->getDelegate()->getColumnDimension('C')->setWidth(12);
                $event->sheet->getDelegate()->getColumnDimension('D')->setWidth(12.5);
                $event->sheet->getDelegate()->getColumnDimension('E')->setWidth(11.5);
                $event->sheet->getDelegate()->getColumnDimension('F')->setWidth(12.6);
                $event->sheet->getDelegate()->getColumnDimension('G')->setWidth(12.5);
