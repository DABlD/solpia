...
class KlcsmOnOff implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                // HC VC
                $h[4] = [
                    'B2:G' . (12 + (sizeof($this->onBoards) * 2)  + (sizeof($this->linedUps) * 2))
                ];

                // HL
                $h[5] = [
                    'B2', 'B' . (8 + (sizeof($this->linedUps) * 2))
                ];
                ...
                $h['wrap'] = [
                    'C3:C' . (10 + (sizeof($this->onBoards) * 2)  + (sizeof($this->linedUps) * 2))
                ];
                ...
                // ALL BORDER THIN
                $cells[0] = array_merge([
                    'B3' . ':G' . (4 + (sizeof($this->linedUps) * 2)),
                    'B' . (9 + (sizeof($this->linedUps) * 2)) . ':G' . (10 + (sizeof($this->linedUps) * 2) + (sizeof($this->onBoards) * 2)),
                ]);
    ...
    public function drawings()
    {
        ...
        $drawing->setPath(public_path("images/klcsm_logo.png"));
        ...
        $drawing2->setPath(public_path("images/klcsm_header.png"));
        $drawing2->setResizeProportional(false);
        $drawing2->setHeight(45);
        $drawing2->setWidth(320);
        ...
        $drawing3->setCoordinates('G' . (13 + (sizeof($this->onBoards) * 2)  + (sizeof($this->linedUps) * 2)));
