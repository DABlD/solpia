    ...
    public function initNulls($type, $fleet){
        ...
        elseif($fleet == "FLEET B"){
            ...
            elseif($type == "kos_bul_mar"){
                if($rank == "C/O"){
                    $this->rows    = 64 + $additional;
                    $this->view    = "CO";
                }
                elseif($rank == "2/O" || $rank == "3/O"){
                    $this->rows    = 63 + $additional;
                    $this->view    = "2O_3O";
                }
                elseif($rank == "BSN" || $rank == "AB"){
                    $this->rows    = 48 + $additional;
            ...
            elseif($type == "kos_cb_lib"){
                if($rank == "C/O"){
                    $this->rows    = 57 + $additional;
                    $this->view    = "CO";
                }
                elseif($rank == "2/O" || $rank == "3/O"){
                    $this->rows    = 58 + $additional;
                    $this->view    = "2O_3O";
                }
                elseif($rank == "BSN" || $rank == "AB"){
                    $this->rows    = 46 + $additional;
        ...
        elseif($fleet == "TOEI"){
            ...
            elseif($rank == "BSN" || $rank == "AB" || $rank == "ABD"){
                $this->rows    = 42;
                $this->view    = "BSN_AB";
            }
            elseif($rank == "OS" || $rank == "DCDT"){
            ...
            elseif($rank == "OLR1" || $rank == "OLR" || $rank == "ABE"){
                $this->rows    = 42;
                $this->view    = "OLR1_OLR";
            }
            elseif($rank == "WPR" || $rank == "ECDT"){
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->getHeaderFooter()->setOddFooter("&L&IDOC NO: SMOP-CDFC-11 &C&IEFFECTIVE DATE: 01 SEPT 17 &R&IREVISION NO: 1.0\n9/23/2021");
                ...
                $event->sheet->getDelegate()->getPageMargins()->setFooter(0.4);
