...
class DocumentChecklist implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    public function initNulls($type, $fleet){
        ...
        elseif($rank == "BSN" || $rank == "AB" || $rank == "OS" || $rank == "PMN" || $rank == "DCDT" || $rank == "ABD" || $rank == "DBOY"){
            $this->view    = "BSN_AB_OS";
        }
        elseif($rank == "C/E" || $rank == "1AE" || $rank == "2E" || $rank == "GE"){
            $this->view    = "CE_1AE";
        }
        elseif($rank == "2AE" || $rank == "3E" || $rank == "3AE" || $rank == "4E"){
            $this->view    = "2AE_3AE";
        }
        elseif($rank == "OLR" || $rank == "OLR1" || $rank == "WPR" || $rank == "ECDT" || $rank == "ABE" || $rank == "FTR" || $rank == "EBOY" || $rank == "WLDR"){
            $this->view    = "OLR1_OLR_WPR";
        }
        elseif($rank == "ELECT" || $rank == "ETO"){
            $this->view    = "ETO";
        }
        elseif($rank == "ETR"){
            $this->view    = "ETR";
        }
        elseif($rank == "CCK" || $rank == "MSM" || $rank == "MBY" || $rank == "CBY" || $rank == "2CK" || $rank == "UTY" || $rank == "COOK"){
