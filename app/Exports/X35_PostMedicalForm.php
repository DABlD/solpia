...
class X35_PostMedicalForm implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    public function __construct($data, $type){
        $data->load('current_lineup.rank');
        $data->load('pro_app.vessel');
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->setTitle('Post Medical Form', false);
                $event->sheet->getDelegate()->getHeaderFooter()->setOddFooter("&L&IDOC NO: SMCL-RPM-09 &C&IEFFECTIVE DATE: 01 SEPT 17 &R&IREVISION NO: 0.0");
                ...
                $event->sheet->getDelegate()->getColumnDimension('B')->setWidth(6); //CHECKBOX
                ...
                $event->sheet->getDelegate()->getColumnDimension('F')->setWidth(19);
