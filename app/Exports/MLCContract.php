...
class MLCContract implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        ...
        if($class == "App\Exports\MLC\HMM"){
            $cm1 = [6791, 7569, 7169, 6245, 7947, 6517, 4433, 33, 36, 37, 38, 4101, 4627, 3822, 4628, 4629, 2069, 2044, 39, 42, 2725, 8630, 8828, 8827, 9379, 9564, 9557, 9539, 9570, 9578, 9605, 6103, 9617];
            $cm1v2 = [8841]; //PRIDE
