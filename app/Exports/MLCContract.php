...
class MLCContract implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        ...
        if($class == "App\Exports\MLC\HMM"){
            $cm1 = [6791, 7569, 7169, 6245, 7947, 6517, 4433, 33, 36, 37, 38, 4101, 4627, 3822, 4628, 4629, 2069, 2044, 39, 42, 2725, 8630, 8828, 8827, 9379, 9564, 9557, 9539, 9570, 9578, 9605];
            $cm1v2 = [8841]; //PRIDE
            $cm1p5 = [8791, 8478, 9218, 9438, 7271, 9591, 9608];
            $cm2 = [6072, 5801, 5842, 5553, 4623, 4637, 6829, 7108, 7141, 7517, 7917, 7998, 8169, 9274, 9586];
