...
class x24_CADETFormatContract implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    public function __construct($data, $type, $req){
        ...
        $data->load('educational_background');
        ...
        $data->pro_app->load('rank');
        $data->pro_app->load('vessel');
    ...
    {
        return view('exports.poea.' . lcfirst($this->type), [
            'data' => $this->data,
        ]);
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->getRowDimension(6)->setRowHeight(17);
                $event->sheet->getDelegate()->getRowDimension(7)->setRowHeight(25);
                $event->sheet->getDelegate()->getRowDimension(8)->setRowHeight(25);
                $event->sheet->getDelegate()->getRowDimension(26)->setRowHeight(25);
                $event->sheet->getDelegate()->getRowDimension(34)->setRowHeight(25);
                $event->sheet->getDelegate()->getRowDimension(50)->setRowHeight(30);
                $event->sheet->getDelegate()->getRowDimension(57)->setRowHeight(30);
                ...
                $event->sheet->getDelegate()->getStyle('A5:A6')->getFont()->setSize(12);
