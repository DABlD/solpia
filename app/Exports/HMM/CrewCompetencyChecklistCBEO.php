...
class CrewCompetencyChecklistCBEO implements FromView, WithEvents//, WithDrawings//, ShouldAutoSize
{
    ...
    {
        return view('exports.checklists.FLEET_B.HMM.CrewCompetencyChecklistCBEO', [
            'data' => $this->data,
        ]);
    }
