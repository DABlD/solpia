...
class CrewCompetencyChecklistTRatings implements FromView, WithEvents//, WithDrawings//, ShouldAutoSize
{
    ...
    {
        return view('exports.checklists.FLEET_B.HMM.CrewCompetencyChecklistTRatings', [
            'data' => $this->data,
        ]);
    }
