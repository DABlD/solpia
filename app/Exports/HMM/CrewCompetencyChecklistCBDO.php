...
class CrewCompetencyChecklistCBDO implements FromView, WithEvents//, WithDrawings//, ShouldAutoSize
{
    ...
    {
        return view('exports.checklists.FLEET_B.HMM.CrewCompetencyChecklistCBDO', [
            'data' => $this->data,
        ]);
    }
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $h[5] = [
                    'A3',
                    'B7:B18', 'C19:C39',
                    'B40:B49', 'C50:C51', 'B52:B53', 'A54:A56', 'A59:A60',
                    'I7:I56'
                ];
                ...
                $event->sheet->getDelegate()->getStyle('D7:D56')->getFont()->setSize(7);
            },
        ];
    }
