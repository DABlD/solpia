...
class CrewCompetencyChecklistTDO implements FromView, WithEvents//, WithDrawings//, ShouldAutoSize
{
    ...
    {
        return view('exports.checklists.FLEET_B.HMM.CrewCompetencyChecklistTDO', [
            'data' => $this->data,
        ]);
    }
