...
class CrewCompetencyChecklistCBRatings implements FromView, WithEvents//, WithDrawings//, ShouldAutoSize
{
    ...
    {
        return view('exports.checklists.FLEET_B.HMM.CrewCompetencyChecklistCBRatings', [
            'data' => $this->data,
        ]);
    }
