    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->getStyle('A1:K35')->getFont()->setName('Times New Roman');
                $event->sheet->getDelegate()->getStyle('A1:K35')->getFont()->setSize(10);
                ...
                // VC
                $h[7] = [
                    'A9:A28', 'A32', 'C32', 'I9:I28', 'B7', 'E7', 'H7'
                ];
                ...
                // FOR THE CHECK
                $event->sheet->getDelegate()->getStyle('F29:F32')->getFont()->setName('Marlett');

                // COLUMN RESIZE
                $event->sheet->getDelegate()->getColumnDimension('A')->setWidth(13.5);
                $event->sheet->getDelegate()->getColumnDimension('B')->setWidth(12.8);
                ...
                $event->sheet->getDelegate()->getColumnDimension('I')->setWidth(28.5);
