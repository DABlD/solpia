...
class X11_CrewCompetencyChecklist implements FromView, WithEvents, WithColumnFormatting//, WithDrawings//, ShouldAutoSize
{
    public function __construct($data, $type, $req, $title = "필리핀"){
        ...
        $data->rank = Rank::find($data->pro_app->rank_id)->abbr;
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                // ALL BORDER THIN
                $cells[0] = array_merge([
                    'A2:I4', 'A6:I' . (62 + $tar), 'A' . (64 + $tar) . ':I' . (66 + $tar)
                ]);
                ...
                // FOR THE CHECK
                $event->sheet->getDelegate()->getStyle('A53')->getFont()->setSize(10);
