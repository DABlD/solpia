...
class HmmTanker implements FromView, WithEvents, WithColumnFormatting//, WithDrawings//, ShouldAutoSize
{
    ...
    {
        return view('exports.monitoring.hmmTanker', [
            'data' => $this->data,
            'vessel' => $this->vessel,
        ]);
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->getColumnDimension('AM')->setWidth(80);
                ...
                $event->sheet->getDelegate()->getStyle('A4:AM' . (sizeof($this->data) + 4))->getFont()->setSize(8);
                $event->sheet->getDelegate()->getStyle('A4:AM' . (sizeof($this->data) + 4))->getFont()->setName('Arial Narrow');
                ...
                $event->sheet->getDelegate()->getStyle('L5:AM' . (sizeof($this->data) + 4))->setConditionalStyles($conditionalStyles);
                ...
                $conditionalStyles = $event->sheet->getDelegate()->getStyle('U5:AL' . (sizeof($this->data) + 4))->getConditionalStyles();
                $conditionalStyles[] = $conditional;

                $event->sheet->getDelegate()->getStyle('U5:AL' . (sizeof($this->data) + 4))->setConditionalStyles($conditionalStyles);
            },
        ];
    }
