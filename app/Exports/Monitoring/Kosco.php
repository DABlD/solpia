...
class Kosco implements FromView, WithEvents, WithColumnFormatting//, WithDrawings//, ShouldAutoSize
{
    ...
    {
        return view('exports.monitoring.kosco', [
            'data' => $this->data,
            'vessel' => $this->vessel,
        ]);
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->getColumnDimension('AG')->setWidth(80);
                ...
                $event->sheet->getDelegate()->getStyle('A4:AG' . (sizeof($this->data) + 4))->getFont()->setSize(8);
                $event->sheet->getDelegate()->getStyle('A4:AG' . (sizeof($this->data) + 4))->getFont()->setName('Arial Narrow');
                $event->sheet->getDelegate()->getStyle('E4:E' . (sizeof($this->data) + 4))->getFont()->getColor()->setARGB(\PhpOffice\PhpSpreadsheet\Style\Color::COLOR_BLUE);
                ...
                $conditionalStyles = $event->sheet->getDelegate()->getStyle('L5:AF' . (sizeof($this->data) + 4))->getConditionalStyles();
                $conditionalStyles[] = $conditional;

                $event->sheet->getDelegate()->getStyle('L5:AG' . (sizeof($this->data) + 4))->setConditionalStyles($conditionalStyles);
                ...
                $conditionalStyles = $event->sheet->getDelegate()->getStyle('L5:R' . (sizeof($this->data) + 4))->getConditionalStyles();
                $conditionalStyles[] = $conditional;

                $event->sheet->getDelegate()->getStyle('L5:R' . (sizeof($this->data) + 4))->setConditionalStyles($conditionalStyles);
                ...
                $conditionalStyles = $event->sheet->getDelegate()->getStyle('T5:AF' . (sizeof($this->data) + 4))->getConditionalStyles();
                $conditionalStyles[] = $conditional;

                $event->sheet->getDelegate()->getStyle('T5:AF' . (sizeof($this->data) + 4))->setConditionalStyles($conditionalStyles);
            },
        ];
    }
