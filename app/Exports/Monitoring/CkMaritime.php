...
class CkMaritime implements FromView, WithEvents, WithColumnFormatting//, WithDrawings//, ShouldAutoSize
{
    ...
    {
        return view('exports.monitoring.ckmaritime', [
            'data' => $this->data,
            'vessel' => $this->vessel,
        ]);
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->getColumnDimension('AJ')->setWidth(12);
                $event->sheet->getDelegate()->getColumnDimension('AK')->setWidth(12);
                $event->sheet->getDelegate()->getColumnDimension('AL')->setWidth(12);
                $event->sheet->getDelegate()->getColumnDimension('AM')->setWidth(12);
                $event->sheet->getDelegate()->getColumnDimension('AN')->setWidth(80);
                ...
                $event->sheet->getDelegate()->getStyle('A4:AN' . (sizeof($this->data) + 4))->getFont()->setSize(8);
                $event->sheet->getDelegate()->getStyle('A4:AN' . (sizeof($this->data) + 4))->getFont()->setName('Arial Narrow');
                $event->sheet->getDelegate()->getStyle('E5:E' . (sizeof($this->data) + 4))->getFont()->getColor()->setARGB(\PhpOffice\PhpSpreadsheet\Style\Color::COLOR_BLUE);
                ...
                $conditionalStyles = $event->sheet->getDelegate()->getStyle('L5:AM' . (sizeof($this->data) + 4))->getConditionalStyles();
                $conditionalStyles[] = $conditional;

                $event->sheet->getDelegate()->getStyle('L5:AN' . (sizeof($this->data) + 4))->setConditionalStyles($conditionalStyles);
                ...
                $conditionalStyles = $event->sheet->getDelegate()->getStyle('L5:T' . (sizeof($this->data) + 4))->getConditionalStyles();
                $conditionalStyles[] = $conditional;

                $event->sheet->getDelegate()->getStyle('L5:T' . (sizeof($this->data) + 4))->setConditionalStyles($conditionalStyles);
                ...
                $conditionalStyles = $event->sheet->getDelegate()->getStyle('V5:AM' . (sizeof($this->data) + 4))->getConditionalStyles();
                $conditionalStyles[] = $conditional;

                $event->sheet->getDelegate()->getStyle('V5:AM' . (sizeof($this->data) + 4))->setConditionalStyles($conditionalStyles);
            },
        ];
    }
