...
class X08_KoscoWaiver implements FromView, WithEvents//, WithDrawings//, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->setTitle('KOSCO WAIVER', false);
                $event->sheet->getDelegate()->getPageSetup()->setFitToHeight(0);
                $event->sheet->getDelegate()->getPageMargins()->setTop(0.9);
                $event->sheet->getDelegate()->getPageMargins()->setLeft(0.5);
                $event->sheet->getDelegate()->getPageMargins()->setBottom(0.9);
                $event->sheet->getDelegate()->getPageMargins()->setRight(0.5);
                $event->sheet->getDelegate()->getPageMargins()->setHeader(0.9);
                $event->sheet->getDelegate()->getPageMargins()->setFooter(0.9);
                ...
                // COLUMN RESIZE
                $event->sheet->getDelegate()->getColumnDimension('A')->setWidth(93);
