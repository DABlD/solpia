...
class X36_CrewInformation implements FromView, WithEvents, WithDrawings//, ShouldAutoSize////
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                // COLUMN RESIZE
                $event->sheet->getDelegate()->getColumnDimension('A')->setWidth(27);
    ...
    public function drawings()
    {
        ...
        $drawing->setPath(public_path("images/shoe_size_chart.png"));
