...
class KmtcChemR implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->setTitle('RATING-CHEMICAL', false);
                ...
                $h[5] = [
                    ...
                    'B14:B33', 'I14:I33', 'A34', 'A41', 'A48', 'A54',
                    'B35:B40', 'B42:B47', 'B49',
                    'A35:A40', 'A42:A44', 'A51:A52',
                    'I35:I40', 'I42:I44', 'I51:I52'
                ];

                // B
                $h[6] = [
                    'A1', 'A2', 'A8', 'A13', 'A34', 'A41', 'A48'
                ];
                ...
                $event->sheet->getDelegate()->getStyle('I14:I52')->getFont()->setSize(8);
                $event->sheet->getDelegate()->getStyle('I14:I52')->getFont()->setName('돋움');
    ...
    public function drawings()
    {
        ...
        $drawing->setPath(public_path("images/kmtc.png"));
