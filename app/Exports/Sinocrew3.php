...
class Sinocrew3 implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        ...
        $sss = sizeof($this->data->sea_service);
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle, $sss) {
                ...
                $event->sheet->getDelegate()->getStyle('A1:I150')->getFont()->setSize(9);
                $event->sheet->getDelegate()->getStyle('A1:I150')->getFont()->setName('Calibri');
            },
        ];
    }
