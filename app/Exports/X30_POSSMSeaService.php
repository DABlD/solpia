...
class X30_POSSMSeaService implements FromView, WithEvents, ShouldAutoSize//, WithDrawings
{
    ...
    {
        return view('exports.possm.' . lcfirst($this->type), [
            'data' => $this->data,
        ]);
    }
    ...
    public function registerEvents(): array
    {
        ...
        $size2 = $this->data->sea_service->count();
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle, $size2) {
                ...
                $event->sheet->getDelegate()->setTitle('SEA SERVICE', false);
