...
class X32_CrewUniform implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    public function __construct($data, $type, $req){
        $data = Applicant::whereIn('id', $req['crews'])->get();
