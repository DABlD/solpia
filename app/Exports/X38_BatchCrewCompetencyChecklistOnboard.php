...
use App\Models\{Applicant, Vessel, Rank, LineUpContract};

class X38_BatchCrewCompetencyChecklistOnboard implements WithMultipleSheets
{
    use Exportable;
    ...
    public function __construct($a,$b, $data){
        ...
        $lucs = LineUpContract::where("vessel_id", $vessel->id)->where("status", "On Board")->select("applicant_id", 'vessel_id')->get();
