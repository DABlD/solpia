...
class x19_LineUpCrewPerVessel implements FromView, WithEvents//, WithDrawings//, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle, $data) {
                ...
                $event->sheet->getDelegate()->setTitle('Sheet 1', false);
                ...
                $event->sheet->getDelegate()->getColumnDimension('D')->setWidth(33);
