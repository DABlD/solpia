...
class Statistics implements FromView, WithEvents//, WithDrawings//, ShouldAutoSize
{
    ...
    {
        return view('exports.reports.statisticReport', [
            'data' => $this->data,
        ]);
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->getColumnDimension('AC')->setWidth(17);
                $event->sheet->getDelegate()->getColumnDimension('AJ')->setWidth(17);
