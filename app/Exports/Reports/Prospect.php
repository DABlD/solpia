...
class Prospect implements FromView, WithEvents//, WithDrawings//, ShouldAutoSize
{
    ...
    {
        return view('exports.reports.prospect', [
            'data' => $this->data,
            'from' => $this->from,
            'to' => $this->to,
        ]);
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle, $sod) {
                ...
                $event->sheet->getDelegate()->setTitle('WEEKLY REPORT', false);
