...
class Prospect2 implements FromView, WithEvents, ShouldAutoSize//, WithDrawings//
{
    ...
    {
        return view('exports.reports.prospect2', [
            'data' => $this->data,
            'from' => $this->from,
            'to' => $this->to,
        ]);
    ...
    public function registerEvents(): array
    {
        ...
        $sod = sizeof($this->data);

        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle, $sod) {
                // SHEET SETTINGS
                $size = \PhpOffice\PhpSpreadsheet\Worksheet\PageSetup::PAPERSIZE_A4;
                $event->sheet->getDelegate()->getPageSetup()->setPaperSize($size);
                $event->sheet->getDelegate()->setTitle('PROSPECT REPORT', false);
                ...
                // SET PRINT AREA
                $event->sheet->getDelegate()->getPageSetup()->setPrintArea("A1:K" . ($sod + 2));

                // CUSTOM FONT AND STYLE TO DEFINED CELL
                $event->sheet->getDelegate()->getStyle('A1:K300')->getFont()->setSize(10);
                $event->sheet->getDelegate()->getStyle('A1:K300')->getFont()->setName('Times New Roman');
