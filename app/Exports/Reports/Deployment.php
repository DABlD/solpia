...
class Deployment implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    {
        return view('exports.reports.deployment', [
            'data' => $this->data,
        ]);
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle, $year) {
                // SHEET SETTINGS
                $size = \PhpOffice\PhpSpreadsheet\Worksheet\PageSetup::PAPERSIZE_A4;
                $event->sheet->getDelegate()->getPageSetup()->setPaperSize($size);
                $event->sheet->getDelegate()->setTitle($year, false);
                ...
                $event->sheet->getDelegate()->getColumnDimension('S')->setWidth(26);
                $event->sheet->getDelegate()->getColumnDimension('U')->setWidth(26);
                ...
                $event->sheet->getDelegate()->getStyle('A1:S50')->getFont()->setSize(9);
                $event->sheet->getDelegate()->getStyle('B2')->getFont()->setSize(18);
                // $event->sheet->getDelegate()->getStyle('A1:S50')->getFont()->setName('Arial');
            },
        ];
    }
