...
class X20_DebriefingForm implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->setTitle('Debriefing Form', false);
                ...
                // $event->sheet->getDelegate()->getStyle('A1:K100')->getFont()->setSize(11);
                $event->sheet->getDelegate()->getStyle('A1:K100')->getFont()->setName('Times New Roman');
            },
        ];
    }
