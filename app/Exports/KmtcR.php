...
class KmtcR implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->setTitle('RATING-LPG', false);
                ...
                $event->sheet->getDelegate()->getStyle('I14:I32')->getFont()->setSize(8);
                $event->sheet->getDelegate()->getStyle('I14:I32')->getFont()->setName('돋움');
