...
class KmtcDO implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->setTitle('DECK OFFICER-LPG', false);
                ...
                $h[5] = [
                    ...
                    'B14:B36', 'I14:I36', 'A37', 'A42', 'A47', 'A49', 'A53',
                    'A38:A41', 'A43:A46', 'A48', 'A50:A51',
                    'I38:I41', 'I43:I46', 'I48', 'I50:I51'
                ];

                // B
                $h[6] = [
                    'A1', 'A2', 'A8', 'A13', 'A37', 'A42', 'A47', 'A49'
                ];
