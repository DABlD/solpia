...
class KmtcEO implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->getHeaderFooter()->setOddFooter('&LKSQ-4124-B / 2019.03.01 / RETENTION : 3 YEARS');
                $event->sheet->getDelegate()->getHeaderFooter()->setEvenFooter('&LKSQ-4124-B / 2019.03.01 / RETENTION : 3 YEARS');
