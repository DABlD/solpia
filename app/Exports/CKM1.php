...
class CKM1 implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        return view('exports.ckmaritime1', [
            'applicant' => $this->data,
            'ssTotalM' => $ssTotalM,
            'ssTotalY' => $ssTotalY
        ]);
    ...
    public function drawings()
    {
		...
		$drawing3->setName('Sir Dennis Sig');
		$drawing3->setDescription('Sir Dennis Sig');
        $drawing3->setPath(public_path('images/sir_dennis_sig.jpg'));
