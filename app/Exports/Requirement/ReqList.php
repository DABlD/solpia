...
namespace App\Exports\Requirement;
...
class ReqList implements FromView, WithEvents, ShouldAutoSize//, WithDrawings
{
    ...
    {
        return view('exports.requirement.list', [
            'data' => $this->data
        ]);
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle, $sod) {
                ...
                $event->sheet->getDelegate()->setTitle('Requirement List', false);
                ...
                $event->sheet->getDelegate()->getStyle('A1:R100')->getFont()->setSize(10);
                $event->sheet->getDelegate()->getStyle('A1:R100')->getFont()->setName('Calibri');
            },
        ];
    }
