...
class KLCSMLNG implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    public function __construct($applicant, $title = "HMM MLC"){
        ...
        if(in_array($applicant->vessel->name, ["M/T SM KESTREL", "M/T FUELNG VENOSA", "M/T SM BLUEBIRD", "M/T K.FREESIA", "SM GOLDEN EAGLE", "M/T SM ALBATROSS"])){
    ...
    public function drawings()
    {
        ...
        $mlcStamp = "images/mlc_klcsm_lng_new.png";
