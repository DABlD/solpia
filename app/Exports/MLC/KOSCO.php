    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->getStyle('B24')->getFont()->setSize(8);
                $event->sheet->getDelegate()->getStyle('B29')->getFont()->setSize(8);
                $event->sheet->getDelegate()->getStyle('B30')->getFont()->setSize(8);
                // SET PRINT AREA
