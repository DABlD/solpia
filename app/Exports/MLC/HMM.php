...
class HMM implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    public function __construct($applicant, $title = "HMM MLC"){
        // CM1
        $this->cm1 = [6791, 7569, 7169, 6245, 7947, 6517, 4433, 33, 36, 37, 38, 6829, 4101, 4627, 3822, 4628, 4629, 2069, 2044, 39, 42, 2725, 8630, 8841, 8828, 8827];
        ...
        $array6 = [
            'M/V BAMBOO STAR', 'M/V OCEAN FLORA', 'M/V HYUNDAI PARAMOUNT'
        ];
