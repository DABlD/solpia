    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle, $title, $mt) {
                ...
                // TO PAGE 2
                $event->sheet->getDelegate()->getRowDimension(37 + $mt)->setRowHeight(40);
                $event->sheet->getDelegate()->getRowDimension(38 + $mt)->setRowHeight(20);
                // END
                ...
                if(in_array($this->applicant->vessel->id, [7141, 7517])){
                    ...
                    $event->sheet->getDelegate()->getRowDimension(1)->setRowHeight(5);
                    ...
                    $event->sheet->getDelegate()->getRowDimension(40)->setRowHeight(5);
