...
class KSSLine3 implements FromView, WithEvents//, ShouldAutoSize//, WithDrawings//
{
    ...
    {
        $exportView = str_replace(' ', '_', $this->data->vessel->fleet) . '.' . 'kssline3';
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->setTitle('code2', false);
                ...
                $event->sheet->getDelegate()->getStyle('A1:K25')->getFont()->setSize(11);
