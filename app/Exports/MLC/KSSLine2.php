...
class KSSLine2 implements FromView, WithEvents//, ShouldAutoSize//, WithDrawings
{
    ...
    {
        $exportView = str_replace(' ', '_', $this->data->vessel->fleet) . '.' . 'kssline2';
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                $event->sheet->getDelegate()->setTitle('code1', false);
                ...
                $event->sheet->getDelegate()->getStyle('A1:G2')->getFont()->setSize(11);
