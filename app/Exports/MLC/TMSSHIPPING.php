...
class TMSSHIPPING implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    {
        $exportView = str_replace(' ', '_', $this->data->vessel->fleet) . '.tmsShipping';
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                // HC VC
                $h[4] = [
                    'A1', 'A3:K18', 'J15:K17', 'G24:G38', 'C94:F94'
                ];
                ...
                $cells[12] = array_merge([
                    'I15:J15', 'I16:J16', 'I17:J17', 'J20:K20',
                    'F24', 'F27', 'F30', 'F32', 'F35', 'F38',
                    'C94:D94', 'F94',

                    'H149:J149', 'H151:K151', 'H153:K153'
                ]);
                ...
                $event->sheet->getDelegate()->getColumnDimension('D')->setWidth(8.5);
                ...
                $rows = [
                    ...
                    [
                        13, //ROW HEIGHT
                        48,100 //START ROW, END ROW
                    ],
                    [
                        15, //ROW HEIGHT
                        104,148 //START ROW, END ROW
                    ],
                ];
                ...
                $event->sheet->getDelegate()->getStyle($cell)->getFont()->setName('Malgun Gothic');
            },
        ];
    }
