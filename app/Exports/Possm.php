...
class Possm implements FromView, WithEvents, WithDrawings//, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($borderStyle, $fillStyle, $headingStyle) {
                ...
                // CELL COLOR
                $event->sheet->getDelegate()->getStyle('C2')->getFont()->getColor()->setRGB('808080');
                ...
                //     return $temp;
                // };
                $rass = 50 + sizeof($this->data->sea_service) + 1;
                ...
                // HC VC
                $h[4] = [
                    'A49:J' . (50 + sizeof($this->data->sea_service) + 1),
                    'A' . (16 + $rass) . ':J' . (18 + $rass)
                ];

                // HL
                $h[5] = [
                    'A23', 'A30', 'A49', 'A' . (3 + $rass)
                ];
                ...
                $event->sheet->getDelegate()->getColumnDimension('B')->setWidth(6.5);
                ...
                // ROW RESIZE
                $event->sheet->getDelegate()->getRowDimension(5)->setRowHeight(85);
                $event->sheet->getDelegate()->getRowDimension(15)->setRowHeight(3);
                $event->sheet->getDelegate()->getRowDimension(20)->setRowHeight(25);
                $event->sheet->getDelegate()->getRowDimension(21)->setRowHeight(15);
                $event->sheet->getDelegate()->getRowDimension(22)->setRowHeight(3);
                $event->sheet->getDelegate()->getRowDimension(28)->setRowHeight(15);
                $event->sheet->getDelegate()->getRowDimension(29)->setRowHeight(3);
                $event->sheet->getDelegate()->getRowDimension(1 + $rass)->setRowHeight(15);
                $event->sheet->getDelegate()->getRowDimension(2 + $rass)->setRowHeight(3);
                $event->sheet->getDelegate()->getRowDimension(11 + $rass)->setRowHeight(30);
                $event->sheet->getDelegate()->getRowDimension(12 + $rass)->setRowHeight(3);
                $event->sheet->getDelegate()->getRowDimension(15 + $rass)->setRowHeight(75);
    ...
    public function drawings()
    {
        ...
        $drawing->setPath(public_path("images/possm.png"));
        ...
        $drawing2->setWidth(175);
        $drawing2->setOffsetX(3);
        $drawing2->setOffsetY(3);
        $drawing2->setCoordinates('I5');
